    ...
    if (lessonId) {
      fetch(`http://localhost:8000/api/admin/lessons/lesson/${lessonId}`)
        ...
        .then((lesson: LessonEntity) => {
          ...
          setLessonContent(normalizeLessonContent(lesson.content as LessonContent));
          setIsEditing(true);
        })
        .catch(err => setError(err.message));
    }
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-3">
            <div className="bg-white rounded-xl border border-slate-200 p-4 sticky top-24">
              ...
              {selectedSubject && (
                <div className="mb-4">
                  <label className="block text-xs font-semibold text-slate-600 mb-2">Chapter</label>
                  <select
                        ...
                        <div key={video.id} className="p-4 border border-slate-200 rounded-lg">
                          <div className="space-y-3">
                            ...
                            <input
                              ...
                              placeholder="Video URL (YouTube, Vimeo, or file URL)"
                              className="w-full px-3 py-2 border border-slate-300 rounded-lg"
                            />
                            <textarea
